...
outfile = 'xref_test.txt'

def newlines_to_spaces(paragraph):
...
addName="hermen. Steph." cRef="CGL.III.364.29">364, 29</ref>; <ref
addName="hermen. frg. Leid." cRef="CGL.III.400.50">400, 50</ref>; <ref
addName="Absid. Bern." cRef="CGL.III.489.43">489, 43</ref>; <ref
addName="Absid. Vat." cRef="CGL.III.509.9">509, 9</ref>. ἄρνειον <ref
addName="hermen. Leid." cRef="CGL.III.16.6">III 16, 6</ref>; <ref
addName="hermen. Ampl." cRef="CGL.III.88.29">88, 29</ref>; <ref
addName="hermen. Steph." cRef="CGL.III.364.2">364, 2</ref>; <ref
addName="hermen. frg. Brux. / hermen. frg. Leid."
cRef="CGL.III.398.3">398, 3</ref>. <form>agminum</form> ἄρνειον <ref
addName="hermen. Monac." cRef="CGL.III.187.40">III 187, 40</ref>; <ref
addName="hermen. Einsidl." cRef="CGL.III.255.63">255, 63</ref>.""",

r"""<form>Aeneator</form> σαλπικτής <ref addName="Ps.-Phil."
cRef="CGL.II.12.3">II 12, 3</ref>. tubarum factor <ref addName="gl.
nom." cRef="CGL.II.565.22">II 565, 22</ref> (<emph>ubi</emph> cantor
<emph>Hildebrand p.</emph> 5. <emph>male versum</emph>).
<form>aenatores</form> κυμβαλοκροῦσται <ref addName="Ps.-Phil."
cRef="CGL.II.12.4">II 12, 4</ref>. <form>aeneatores</form> tubicines
<ref addName="Abstr. II" cRef="CGL.IV.11.47">IV 11, 47</ref>; <ref
addName="Abstr. II" cRef="CGL.IV.12.3">12, 3</ref>; <ref
addName="Abba" cRef="CGL.IV.204.13">204, 13</ref>; <ref addName="lib.
gl." cRef="CGL.V.163.48">V 163, 48</ref>; <ref addName="Conscr. gl."
cRef="CGL.V.262.48">262, 48</ref>; <ref addName="Conscr. gl."
cRef="CGL.V.266.47">266, 47</ref>; <ref addName="Apod."
cRef="CGL.V.338.42">338, 42</ref>. <form>aenatores</form> cornicines
...
cRef="CGL.IV.306.1">IV 306, 1</ref>; <ref addName="gl. AA"
cRef="CGL.V.437.46">V 437, 46</ref> (cornu). corno (cornu
<emph>ab</emph>) uel calamo cantantes <ref addName="Abba"
cRef="CGL.IV.204.18">IV 204, 18</ref>. <emph>Cf. Festus Pauli</emph>
20, 7.""",

r"""<form>Absonus</form> sine sono homo <ref addName="Apod."
cRef="CGL.V.343.31">V 343, 31</ref>; <ref addName="Conscr. gl."
cRef="CGL.V.259.46">259, 46</ref>. <form>absonum</form> ἀπηχές <ref
addName="Ps.-Cyr." cRef="CGL.II.235.7">II 235, 7</ref>. ἀνάρμοστον
<ref addName="Ps.-Phil." cRef="CGL.II.5.21">II 5, 21</ref>; <ref
addName="gl. Laud." cRef="CGL.II.554.58">554, 58</ref>. ἀπηχές,
ἀμαυρόν <ref addName="gl. Laud." cRef="CGL.II.555.2">II 555, 2</ref>
(<emph>v.</emph> absurdus). sine sono <ref addName="gl. nom."
cRef="CGL.II.563.39">II 563, 39</ref> (= <emph>Non.</emph> 72, 5).
<form>absono</form> non simili sono <ref addName="Abstr. II"
cRef="CGL.IV.5.19">IV 5, 19</ref>; <ref addName="Abba"
...
cRef="CGL.IV.4.44">IV 4, 44</ref> (propero <emph>cod.</emph>); <ref
addName="Abstr. II" cRef="CGL.IV.4.44">IV 4, 44</ref> (propero
<emph>cod.: om. bc</emph>).""",
...
ὑπογάστριον <ref addName="hermen. Leid." cRef="CGL.III.14.40">III 14,
40</ref>; <ref addName="hermen. Montep." cRef="CGL.III.314.41">314,
41</ref>. graece &lt;λαπάρα&gt;, pinguedo carnium (graece <emph>om.
R</emph>) <emph>Plac.</emph> <ref addName="Plac. lib. rom."
cRef="CGL.V.5.7">V 5, 7</ref> = <ref addName="Plac. lib. rom. / Plac.
lib. gl." cRef="CGL.V.43.3">V 43, 3</ref>. pinguedo carnis <ref
addName="gl. Lois. / Absid. Bern." cRef="CGL.III.487.4">III 487,
4</ref>; <ref addName="Absid. Bern. / Absid. Vat."
cRef="CGL.III.506.5">506, 5</ref>; <ref addName="gl. Aynardi"
cRef="CGL.V.615.38">V 615, 38</ref>. ueretrum <ref addName="Abav. mai.
/ Abut." cRef="CGL.V.632.2">V 632, 2</ref>. <form>abdumen</form>
λαπάρα <ref addName="Ps.-Cyr." cRef="CGL.II.358.45">II 358, 45</ref>;
<ref addName="idiom. Harl." cRef="CGL.II.506.22">506, 22</ref>; <ref
addName="gl. Serv." cRef="CGL.II.528.46">528, 46</ref>; <ref
addName="gl. Serv." cRef="CGL.II.529.6">529, 6</ref>; <ref
addName="idiom. nom." cRef="CGL.II.546.47">546, 47</ref>. ὑπογάστριον
<ref addName="Ps.-Phil." cRef="CGL.II.9.42">II 9, 42</ref>; <ref
addName="hermen. Ampl." cRef="CGL.III.87.31">III 87, 31</ref>; <ref
addName="hermen. Einsidl." cRef="CGL.III.255.20">255, 20</ref>.
ὑπογάστριον, λίπος <ref addName="hermen. Monac."
...
for i, paragraph in enumerate(fixed_pars):
    ...
    diff = difflib.context_diff(correct_paragraph, paragraph, fromfile='pre-corrected_par', tofile='test_pars')
    print('\n'.join(list(diff)))
